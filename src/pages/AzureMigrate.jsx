          ...
          >
            ...
            <div className="space-y-0">
              ...
              {[
                ...
                { num: "3", label: "Review & Create", detail: "Click Next. Azure prompts to create a database, which requires another App Service Plan. Click Review & Create to continue." },
              ].map((s, i) => (
                <StepItem key={i} step={s} />
              ))}
            </div>
